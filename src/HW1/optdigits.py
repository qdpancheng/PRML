...
if __name__=='__main__':
    ...
    file_path += r'\DATASET\optdigits\optdigits.tra'
    train_x, train_y = ReadData(file_path)

    file_path = os.path.abspath(os.path.dirname(os.path.dirname(os.getcwd())))
    file_path += r'\DATASET\optdigits\optdigits.tes'
    test_x, test_y = ReadData(file_path)
